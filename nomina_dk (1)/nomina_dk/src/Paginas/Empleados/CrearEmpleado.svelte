            ...
            dataParametros: [
              {
                parametro: "@cedula",
                tipo: 16,
                valor: fEmpleado.cedula.toString().replaceAll('-','')
              },
              {
                parametro: "@nombre",
                tipo: 16,
...
{#if permisosCrud.crud == 1}
   ...
   <main in:fade="{{duration: 500}}">
    ...
    <TituloPagina Titulo={tituloDeLaPagina}></TituloPagina>
    ...
    <article class="rounded-b-2xl rounded-t-2xl p-3 mx-[5%]">
          ...
          <div class="form-control mb-1">
            ...
            <div class="form-control mb-1">
              <div class="input-group relative">
                ...
                <select name="cCargo"  bind:value={fEmpleado.cargo} on:change={validaCargo}  class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
            ...
            <div class="form-control mb-1">
              <div class="input-group relative">
                ...
                <select name="cModulo"  bind:value={fEmpleado.modulo} on:change={validaModulo}  class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
                  <option disabled={true} selected={true}></option> 
            ...
            <div class="form-control mb-1">
              <div class="input-group relative">
                ...
                <select name="cModulo"  bind:value={fEmpleado.departamento} on:change={validaDepartamento} class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
                  <option disabled={true} selected={true}></option> 
            ...
            <div class="form-control mb-1">
              <div class="input-group relative">
                ...
                <select name="cMedioPago"  bind:value={fEmpleado.medioPago} on:change={validaMedioPago}  class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
                  <option disabled={true} selected={true}></option> 
            ...
            <div class="form-control mb-1">
              <div class="input-group relative">
                ...
                <select name="cBanco"  bind:value={fEmpleado.banco} on:change={validaBanco} class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
                  <option disabled={true} selected={true}></option> 
        ...
        <section class="flex justify-end">
          <button on:click={()=>registroEmpleado()} class="btn btn-md mt-1 mx-1 bg-green-700 font-bold border-none hover:bg-white hover:text-green-700">Registrar Empleado</button>
      </section>
        </article>
...
{:else}
   <!-- else content here -->
   <h1>Usted no posee permisos para esta opcion</h1>
{/if}
