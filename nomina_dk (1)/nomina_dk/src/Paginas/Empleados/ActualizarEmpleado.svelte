        ...
        !eEmpleado.fechaEntrada && !eEmpleado.modulo && !eEmpleado.medioPago && !eEmpleado.salario && !eEmpleado.salarioEspecial && !eEmpleado.banco)
    {
      ...
      const cargaEmpleado=()=>{
          if(empleados.length>0)
          {
            ...
            fEmpleado.medioPago=empleados[0].medioPago.toString();
...
<main in:fade="{{duration: 500}}">
  ...
  <TituloPagina Titulo="ACTUALIZAR EMPLEADO"></TituloPagina>
      ...
      <section class="pt-0">
        ...
        <div class="form-control mb-1">
            <div class="input-group relative">
              ...
              <button on:click={()=>ModificarEmpleado()} class="btn bg-yellow-500 border-none">Modificar</button>
              {#if eCedula}
          ...
          <div class="form-control mb-1">
            <div class="input-group relative">
              ...
              <select name="cCargo"  bind:value={fEmpleado.cargo} 
               ...
               autocomplete="off"
               class="select select-bordered font-normal text-lg text-gray-500 w-[400px]">
