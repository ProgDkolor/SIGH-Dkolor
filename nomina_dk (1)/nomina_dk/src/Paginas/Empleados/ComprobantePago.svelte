            ...
            "dataParametros": [
              {
                "parametro": "@periodo",
                "tipo": 16,
                "valor": periodoNomina.replaceAll('-','')
              }
            ]
          } 
          $verModalLoading=true;
...
<main in:fade="{{duration: 500}}">
  ...
  <TituloPagina Titulo="COMPROBANTE DE PAGO"></TituloPagina>
        ...
        <div class="form-control mb-1">
          <div class="input-group relative">
            ...
            <MaskedInput
              ...
              options={marcaraPeriodo}
              type="text"
              on:complete={()=>validaPeriodo()}
              class="input input-bordered text-lg text-gray-500 w-[400px]"  name="tPeriodoNomina" 
            />
...
{:else}
   <!-- else content here -->
   <p>No posee permisos para esta seccion</p>
{/if}